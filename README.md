...
1. (2023) **Ananke: A module for causal inference.** *Jaron J. R. Lee, Rohit Bhattacharya, Razieh Nabi, Ilya Shpitser*. [[link](https://ananke.readthedocs.io/en/latest/#)] [[pdf](https://arxiv.org/pdf/2301.11477)]
1. (2020) **CausalML: Python Package for Causal Machine Learning.** [[GitHub](https://github.com/uber/causalml)] [[pdf](https://arxiv.org/pdf/2002.11631.pdf)]
...
6. (2024 arXiv) **CLEAR: Can Language Models Really Understand Causal Graphs?**
   _Sirui Chen, Mengying Xu, Kun Wang, Xingyu Zeng, Rui Zhao, Shengjie Zhao, Chaochao Lu_. 
   [[pdf](https://arxiv.org/pdf/2406.16605)]
7. (2024 arXiv) **Evaluating Interventional Reasoning Capabilities of Large Language Models.**
...
7. (2020 IJCAI) **Guided Generation of Cause and Effect.** _Zhongyang Li, Xiao Ding, Ting Liu, J. Edward Hu, Benjamin Van Durme_.
   ...
   <br>[Summary] 314 million automatically extracted cause and effects. in T
